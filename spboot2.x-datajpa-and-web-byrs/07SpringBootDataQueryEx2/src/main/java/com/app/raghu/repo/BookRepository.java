...
public interface BookRepository extends JpaRepository<Book, Integer>
{
	...
	//@Query("SELECT b FROM Book b WHERE b.author=?1")  //using positional parameter sql query(In JPA index starts from 1)
	@Query("SELECT b FROM Book b WHERE b.author = :abc")  //using named parameter sql query
